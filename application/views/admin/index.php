...
<div class="bg-gradient-light">
 ...
 <div class="col-auto">
 <a href="<?= base_url('buku'); ?>"><i class="fas fa-book fa-3x text-warning"></i></a>
 </div>
</div>
</div>
 </div>
 ...
 <div class="col-auto">
 <a href="<?= base_url('user'); ?>"><i class="fas fa-user-tag fa-3x text-warning"></i></a>
 </div>
 </div>
 </div>
 </div>
 ...
 echo $totaldibooking;
  ...
  <span class="fas fa-users text-success mt-2 "> Data User</span>
 ...
 <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2">
 <div class="page-header">
 <span class="fas fa-book text-success mt-2"> Data Buku</span>
